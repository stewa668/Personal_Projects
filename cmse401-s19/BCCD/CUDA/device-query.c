/*
  * $Id: device-query.c,v 1.5 2012/07/07 15:45:59 charliep Exp $
  * 
...
void printDeviceProperties(int deviceID) {
	...
	//		xxx find library with Convert... call, or another way to count the blocks for a total core count
	...
	// 		  ConvertSMVer2Cores(deviceProperties.major, deviceProperties.minor) * deviceProperties.multiProcessorCount);
	//     #endif
// Compute Capability <= 1.3 --> 8 CUDA Cores / SM
// CC == 2.0 --> 32 CUDA cores / SM
// CC == 2.1 --> 48 CUDA cores / SM

Where SM = single multiprocessor. 	
