#!/usr/bin/perl
# $Id: cpuinfo.pl,v 1.1 2012/05/02 18:15:21 charliep Exp $
...
#collects system data to help diagnose errors
use Carp;
use POSIX;

open(my $CPUI, '<', '/proc/cpuinfo') or
	croak "Can't open /proc/cpuinfo for reading: $!\n";
while(my $line = <$CPUI>) {
	chomp $line;
	print "$line\n";
}
